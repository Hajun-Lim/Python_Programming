...
for i in range(10000):
    my_str += str(i)  # 문자열은 매번 새로운 문자열 객체를 생성
end = time.time()
...
for i in range(10):
    my_list.append(
        str(i)
    )  # 리스트는 동일한 객체에 append                           # 동일 리스트 객체에 append
...
print(a[1:5:-1])  # nohtyP 출력 (step이 음수이면 start가 end보다 커야 함)
print(a[1:5:1])  # noth 출력
