...
result = ori.copy()  # 얕은 복사(shallow copy)
print(result)
result.append(10)
print(ori, result)
...
result2 = copy.deepcopy(ori)  # 깊은 복사(deep copy)
result2[0].append(20)  # 사본만 바꿈
print(ori, result2)
...
result = [sum(subject) / len(subject) for subject in (scores)]
print(result)  # ✅ [90.0, 80.0, 70.0]1``
