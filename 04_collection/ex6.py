...
print(a, b, c)  # a=kor, b=[mat, eng], c=prog
print({**d})  # 딕셔너리 언패킹
...
# 점수 90 이상만 필터링하기
scores = {"국어": 90, "영어": 80, "수학": 100, "과학": 70, "사회": 60}
...
result = {subject: "합격" for subject, v in scores.items() if v >= 60}
print(result)
# ✅ {'국어': '합격', '수학': '합격', '사회': '합격'}
...
result = {subject: v for subject, v in zip(subjects, grades)}
